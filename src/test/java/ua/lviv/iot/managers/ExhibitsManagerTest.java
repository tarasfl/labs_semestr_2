...
class ExhibitsManagerTest {
    ...
    void findExhibitsByThemeTest(List<Exhibit> unsortedList, List<Exhibit> expectedList, String theme, int numOfSortedElements, boolean descend) {
        ...
        for (Exhibit obj : sortedTestList) {
            ...
            Assertions.assertEquals(expectedList.get(id).getDateOfCreating(), obj.getDateOfCreating());
            id++;
        }
    }
    ...
    void sortExhibitsByTimeOfPresentingTest(List<Exhibit> unsortedList, List<Exhibit> expectedList, boolean descend) {
        var exhibitsManager = new ExhibitsManager();
        var sortedTestList = exhibitsManager.sortExhibitsByTimeOfPresenting(unsortedList, descend);
        int i = 0;
        for (Exhibit obj : sortedTestList) {
            Assertions.assertEquals(expectedList.get(i).getDateOfPresenting(), obj.getDateOfPresenting());
            i++;
        }
    }
